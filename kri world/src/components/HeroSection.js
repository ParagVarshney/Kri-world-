    ...
    <section className="bg-[#f7efe7] pt-36 pb-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-left">
          <span className="inline-block bg-green-100 text-green-700 px-4 py-1 rounded-full text-2xl font-medium mb-4">
          ...
          <p className="text-gray-700 text-2xl sm:text-2xl leading-relaxed max-w-lg mb-8">
